...
<div id="reviewCard" style="background-color:white; padding:15px; border-radius:20px; margin-bottom:30px;">
    ...
    <div class="d-flex" style="justify-content:space-between">
        ...
        @if(Auth::user() && (Auth::user()->id == $review->user_id || Auth::user()->role == 'admin'))
            <img src="/assets/icons/trash_closed.png" alt="trash_icon" class="picon editProfilePictureBtn" confAction="deleteReview" onclick="showConfirmationModal(this)" review_id="{{$review->id}}" onmouseover="setTrashOpen(this)" onmouseout="setTrashClosed(this)">
        @endif
    </div>
    ...
    <div class="d-flex" style="justify-content:space-between">
        <div>
            ...
            <p style="font-weight:bold">{{ explode(" ", $review->created_at)[0] }} </p>
        </div>
        <div>
