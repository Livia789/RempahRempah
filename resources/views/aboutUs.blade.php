...
@section('title', 'RempahRempah | Tentang kami')
...
@section('content')
    ...
    <div class="section">
        ...
        <div class="description">
            <p>
                RempahRempah dikembangkan oleh tiga mahasiswa jurusan Computer Science di tahun akhir perkuliahan sebagai tugas skripsi.
            </p>
        </div>
    </div>
@endsection
